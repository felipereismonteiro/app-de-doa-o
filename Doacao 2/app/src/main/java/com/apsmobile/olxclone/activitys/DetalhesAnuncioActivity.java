...
import com.apsmobile.olxclone.adapter.SliderAdapter;
...
import com.apsmobile.olxclone.model.Favorito;
import com.apsmobile.olxclone.model.Usuario;
        ...
        like_button.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                if(FirebaseHelper.getAutenticado()){
                    ...
                    alertAutenticacao("Para adicionar este anúncio a sua lista de favoritos é preciso está autenticado no app, deseja fazer isso agora ?");
                }
            }
